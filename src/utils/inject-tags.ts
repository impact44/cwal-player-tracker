export async function injectProTagsInMatchHistory(
    ...
    PRO_MAP: Record<string, { battle_tag: string; aurora_id: number }>,
    ...
    for (let offset = 0; offset < total; offset += chunkSize) {
        ...
        try {
            ...
            rowsChunk.forEach((row, i) => {
                ...
                for (const [proName, { aurora_id }] of Object.entries(PRO_MAP ?? {})) {
                    const proId = aurora_id;
...
export function injectProTag(proName: string): void {
